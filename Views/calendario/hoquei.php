                ...
                <div id="external-events">
                  <form method="post">
                    ...
                    curl_setopt_array($curl, [
                      CURLOPT_URL => "https://allscores.p.rapidapi.com/api/allscores/games-scores?startDate=" . $start . "&langId=1&sport=4&endDate=" . $end . "&timezone=America%2FChicago&onlyMajorGames=true",
